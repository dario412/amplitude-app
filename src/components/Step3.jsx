...
function Step3({ formData, updateFormData, onLogin }) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">New to Amplitude? <a href="#" className="text-blue-600 hover:underline">Sign up</a></p>
      </div>
      ...
      <div className="flex items-center gap-2 mb-8">
        ...
        <div className="w-8 h-8 rounded-full bg-[#1F1F1F] flex items-center justify-center text-white text-sm font-medium">3</div>
      </div>
